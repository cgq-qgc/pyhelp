...
MOCK_MODULES = ['pyhelp.HELP3O', 'pytables']
...
latex_documents = [
    (master_doc, 'PyHelp.tex', 'PyHelp Documentation',
...
man_pages = [
    (master_doc, 'pyhelp', 'PyHelp Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PyHelp', 'PyHelp Documentation',
     author, 'PyHelp', 'One line description of project.',
     'Miscellaneous'),
]
