...
C
C    SETS CONTROLS FOR PRINTING OUTPUT:
C       IOD=1 IF DAILY OUTPUT IS DESIRED.
C       IOM=1 IF MONTHLY OUTPUT IS DESIRED.
C       IOA=1 IF ANNUAL OUTPUT IS DESIRED.
C       IOS=1 IF SUMMARY OUTPUT IS DESIRED.
C
...
C
        ...
        IF (IPRE .LT. 2) THEN
          WRITE (*, 6000)
 6000     FORMAT(/////////
     1 12X,' PERFORMING CALCULATIONS FOR INITIALIZATION.'/
     1 12X,' (MAY TAKE UP TO  60 MIN  ON AN 8088 CPU WITH AN 8087,'/
     2 22X,' UP TO  15 MIN  ON AN 80286 CPU WITH AN 80287, '/
     3 22X,' UP TO   3 MIN  ON AN 80386 CPU WITH AN 80387, OR '/
     4 22X,' UP TO   1 MIN  ON AN 80486 CPU.     '//)
        ELSE
          WRITE (*, 6010) JYEAR(IYR)
 6010     FORMAT(/////////
     1 12X,' PERFORMING CALCULATIONS FOR YEAR',I5,'.'/
     1 12X,' (MAY TAKE UP TO  60 MIN  ON AN 8088 CPU WITH AN 8087,'/
     2 22X,' UP TO  15 MIN  ON AN 80286 CPU WITH AN 80287, '/
     3 22X,' UP TO   3 MIN  ON AN 80386 CPU WITH AN 80387, OR '/
     4 22X,' UP TO   1 MIN  ON AN 80486 CPU.     '//)
...
C
 ...
 6005 FORMAT(///1X,'PRECIPITATION DATA FILE:    ',A50/
     1 1X,'TEMPERATURE DATA FILE:      ',A50/
     2 1X,'SOLAR RADIATION DATA FILE:  ',A50/
     3 1X,'EVAPOTRANSPIRATION DATA:    ',A50/
     4 1X,'SOIL AND DESIGN DATA FILE:  ',A50/
     5 1X,'OUTPUT DATA FILE:           ',A50///)
C
